  ...
  <div class="view">
    ...
    <div class="content" ref="content">
      <select name="major" @change="changeCategory" v-model="Id">
        <option v-for="(item,index) in schoolType" :value="item.id" v-if="item.category === $store.state.searchData.category">{{item.name}}</option>
      </select>
      ...
      getSchool(){
        this.$http({
          ...
          if(response.meta.code == "200"){
            ...
            this.Id = this.$store.state.searchData.id;
          }else{
